        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/signup" className="text-sm text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-orange-400 transition-colors">
                  Post a Job
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <span className="text-sm text-slate-600 dark:text-slate-400">GDPR Data Isolation</span>
              </li>
              <li>
                <span className="text-sm text-slate-600 dark:text-slate-400">Opt-in Proctor Consent</span>
              </li>
            </ul>
          </div>
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-400 dark:text-slate-500">Disclaimer</h4>
