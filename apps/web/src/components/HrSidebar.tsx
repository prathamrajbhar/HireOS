      ...
      <div className="mb-6 px-2">
        <Link href="/" className="flex items-center gap-2.5 group">
          ...
          <span className="font-extrabold text-lg tracking-tight text-slate-800">
            Next<span className="text-brand-600 bg-gradient-to-r from-brand-600 to-success-600 bg-clip-text text-transparent">Round</span>
          </span>
        </Link>
      </div>
            ...
            <div className="space-y-0.5">
              {group.items.map((item) => {
                ...
                return (
                  ...
                  >
                    <Icon className={`h-4.5 w-4.5 transition-transform duration-200 ease-out group-hover:scale-110 ${isActive ? 'text-purple-600' : 'text-slate-400 group-hover:text-slate-600'
                      }`} />
