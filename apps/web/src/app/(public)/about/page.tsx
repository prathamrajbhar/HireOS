    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16 flex-1 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="rounded-3xl border border-white/60 bg-white/40 p-6 md:p-8 shadow-sm backdrop-blur-md glass-panel flex flex-col justify-between">
            <div>
              <div className="h-10 w-10 rounded-xl bg-indigo-50 flex items-center justify-center text-indigo-600 border border-indigo-100 mb-4">
                <Target className="h-5 w-5" />
              </div>
              <h2 className="text-lg font-bold text-slate-800">The Problem We Solve</h2>
          ...
          <div className="rounded-3xl border border-white/60 bg-white/40 p-6 md:p-8 shadow-sm backdrop-blur-md glass-panel flex flex-col justify-between">
            <div>
              <div className="h-10 w-10 rounded-xl bg-purple-50 flex items-center justify-center text-purple-600 border border-purple-100 mb-4">
                <Layers className="h-5 w-5" />
              </div>
              <h2 className="text-lg font-bold text-slate-800">The Marketplace Solution</h2>
              <p className="mt-3 text-xs text-slate-500 leading-relaxed font-semibold">
        ...
        <div className="rounded-3xl border border-white/60 bg-white/40 p-8 shadow-md backdrop-blur-md glass-panel mb-16">
          <div className="flex items-center gap-3 border-b border-slate-100 pb-4 mb-6">
            <Scale className="h-6 w-6 text-indigo-600" />
            <h2 className="text-xl font-bold text-slate-900">How the AI Bias Audit Works</h2>
          </div>
          
          <div className="space-y-6">
            <div className="flex gap-4">
              <div className="h-6 w-6 rounded-full bg-indigo-50 border border-indigo-100 flex items-center justify-center text-indigo-600 font-bold text-xs flex-shrink-0">
                1
              </div>
              <div>
                <h4 className="text-sm font-bold text-slate-800">Marker Anonymization</h4>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-800">Double-Pass Evaluation Check</h4>
                <p className="text-xs text-slate-500 leading-relaxed mt-1 font-semibold">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-800">Full Auditable Transparency</h4>
                <p className="text-xs text-slate-500 leading-relaxed mt-1 font-semibold">
